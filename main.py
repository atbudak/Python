...
def most_frequent_number_2(lst: list):
    lst.sort()
    sorted_value = []
...
# print(most_frequent_number_2([1, 3, 7, 4, 3, 0, 3, 6, 3]))

def most_frequent_number_3():
    numbers = [1, 3, 7, 4, 3, 0, 3, 6, 3]
...
if __name__ == "__main__":
    most_frequent_number_1()
    print(most_frequent_number_2([1, 3, 7, 4, 3, 0, 3, 6, 3]))
    most_frequent_number_3()
    comfortable_word()
    pass_reminder()
    covid_risk()
    Armstrong_Number()
